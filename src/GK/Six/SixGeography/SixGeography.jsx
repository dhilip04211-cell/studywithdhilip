...
const chapters = [
  { title: "Solar System and Earth", topics: ["Planets and stars", "Earth's position", "Moon phases", "Eclipses"] },
  { title: "Latitudes and Longitudes", topics: ["Equator and poles", "Tropics and circles", "Meridians", "Time zones"] },
  { title: "Motions of Earth", topics: ["Rotation", "Revolution", "Seasons formation", "Solstice and Equinox"] },
  { title: "Landforms of Earth", topics: ["Mountains and plains", "Plateaus", "Valleys", "Coastal features"] },
  { title: "Water Bodies", topics: ["Oceans and seas", "Lakes and rivers", "Groundwater", "The water cycle"] },
  { title: "Weather and Climate", topics: ["Elements of weather", "Climate zones", "Rainfall types", "Monsoons"] },

];

export default function SixGeography({ onBack }) {
...
const styles = {
  ...
  bgGlow: {
    position: "fixed",
    inset: 0,
    background: "radial-gradient(ellipse at 50% 0%, #27AE601a 0%, transparent 55%)",
    pointerEvents: "none",
    zIndex: 0,
  },
  container: {
