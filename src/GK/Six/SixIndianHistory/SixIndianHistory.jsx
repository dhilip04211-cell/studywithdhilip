...
const chapters = [
  { title: "Sources of History", topics: ["Types of historical sources", "Archaeological findings", "Literary sources", "Oral traditions"] },
  { title: "The Stone Age", topics: ["Paleolithic Age", "Mesolithic Age", "Neolithic Revolution", "Chalcolithic Period"] },
  { title: "The Indus Valley Civilisation", topics: ["Location and extent", "Town planning and drainage", "Economic life", "Decline of IVC"] },
  { title: "The Vedic Age", topics: ["Rig Vedic period", "Later Vedic period", "Social structure", "Religious practices"] },
  { title: "Jainism and Buddhism", topics: ["Life of Mahavira", "Teachings of Buddhism", "Eight Fold Path", "Spread of religions"] },
  { title: "The Mauryan Empire", topics: ["Chandragupta Maurya", "Ashoka the Great", "Mauryan administration", "Decline of Mauryas"] },

];

export default function SixIndianHistory({ onBack }) {
...
const styles = {
  ...
  bgGlow: {
    position: "fixed",
    inset: 0,
    background: "radial-gradient(ellipse at 50% 0%, #E74C3C1a 0%, transparent 55%)",
    pointerEvents: "none",
    zIndex: 0,
  },
  container: {
