...
const chapters = [
  { title: "Early Tamils", topics: ["Megalithic culture", "Iron Age in Tamil Nadu", "Early settlements", "Archaeological evidence"] },
  { title: "Sangam Literature", topics: ["Ettuthokai", "Patthupattu", "Tolkappiyam", "Sangam poets"] },
  { title: "Ancient Tamil Kingdoms", topics: ["Chera kingdom", "Chola kingdom", "Pandya kingdom", "Boundaries and extent"] },
  { title: "The Three Crowned Kings", topics: ["Cheran Senguttuvan", "Karikala Cholan", "Pandyan Nedunjeliyan", "Wars and diplomacy"] },
  { title: "Tamil Society and Culture", topics: ["Caste system in Sangam age", "Roles of women", "Trade guilds", "Food and festivals"] },
  { title: "Tamil Religion and Philosophy", topics: ["Murugan worship", "Seyon and Mayon", "Korravai", "Nature worship"] },

];

export default function SixTamilnaduHistory({ onBack }) {
...
const styles = {
  ...
  bgGlow: {
    position: "fixed",
    inset: 0,
    background: "radial-gradient(ellipse at 50% 0%, #E67E221a 0%, transparent 55%)",
    pointerEvents: "none",
    zIndex: 0,
  },
  container: {
