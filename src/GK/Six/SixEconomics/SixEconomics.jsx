...
const chapters = [
  { title: "What is Economics?", topics: ["Definition and scope", "Micro vs Macro", "Positive vs Normative", "Economic agents"] },
  { title: "Needs and Wants", topics: ["Hierarchy of needs", "Unlimited wants", "Scarcity concept", "Choice and opportunity cost"] },
  { title: "Goods and Services", topics: ["Consumer goods", "Producer goods", "Public vs Private goods", "Services"] },
  { title: "Production", topics: ["Factors of production", "Land, Labour, Capital", "Entrepreneur", "Production process"] },
  { title: "Markets", topics: ["Market place", "Buyers and sellers", "Price determination basics", "Types of markets"] },
  { title: "Money and Barter", topics: ["Functions of money", "Types of money", "Barter problems", "Coins and notes"] },

];

export default function SixEconomics({ onBack }) {
...
const styles = {
  ...
  bgGlow: {
    position: "fixed",
    inset: 0,
    background: "radial-gradient(ellipse at 50% 0%, #8E44AD1a 0%, transparent 55%)",
    pointerEvents: "none",
    zIndex: 0,
  },
  container: {
