...
const chapters = [
  { title: "Matter Around Us", topics: ["Solids liquids gases", "Changes of state", "Properties comparison", "Plasma state"] },
  { title: "Changes Around Us", topics: ["Physical changes", "Chemical changes", "Examples", "Reversible vs irreversible"] },
  { title: "Acids and Bases", topics: ["Properties of acids", "Properties of bases", "pH scale basics", "Everyday examples"] },
  { title: "Mixtures and Compounds", topics: ["Elements and compounds", "Mixtures", "Separation techniques", "Pure substances"] },
  { title: "Metals and Non-Metals", topics: ["Properties of metals", "Properties of non-metals", "Uses", "Metalloids"] },
  { title: "Water", topics: ["Water as solvent", "Water purification", "Importance of water", "Water pollution"] },

];

export default function SixChemistry({ onBack }) {
...
const styles = {
  ...
  bgGlow: {
    position: "fixed",
    inset: 0,
    background: "radial-gradient(ellipse at 50% 0%, #D354001a 0%, transparent 55%)",
    pointerEvents: "none",
    zIndex: 0,
  },
  container: {
