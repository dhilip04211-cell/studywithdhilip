...
const chapters = [
  { title: "Measurement and Units", topics: ["SI units", "Errors in measurement", "Significant figures", "Dimensional analysis"] },
  { title: "Motion", topics: ["Equations of motion", "Projectile motion", "Circular motion", "Relative velocity"] },
  { title: "Optics", topics: ["Reflection laws", "Refraction", "Total internal reflection", "Lens formula"] },
  { title: "Thermal Physics", topics: ["Specific heat", "Latent heat", "Transfer of heat", "Thermal expansion"] },
  { title: "Electricity", topics: ["Ohm's law", "Resistivity", "Electrical power", "Domestic wiring"] },
  { title: "Nuclear Physics", topics: ["Radioactivity", "Nuclear fission", "Nuclear fusion", "Nuclear power"] },

];

export default function NinePhysics() {
