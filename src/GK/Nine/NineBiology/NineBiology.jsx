...
const chapters = [
  { title: "Cell Biology", topics: ["Cell organelles", "Cell division", "DNA and RNA", "Gene expression"] },
  { title: "Plant Kingdom", topics: ["Cryptogamae", "Phanerogamae", "Classification", "Economic importance"] },
  { title: "Animal Kingdom", topics: ["Phyla of animals", "Vertebrate classes", "Adaptations", "Wildlife"] },
  { title: "Physiology of Plants", topics: ["Transpiration", "Photosynthesis", "Respiration in plants", "Plant hormones"] },
  { title: "Physiology of Animals", topics: ["Nervous system", "Endocrine system", "Reproductive system", "Excretion"] },
  { title: "Applied Biology", topics: ["Biotechnology basics", "Agriculture applications", "Medicine", "Ethics"] },

];

export default function NineBiology() {
