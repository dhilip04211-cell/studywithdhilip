...
const chapters = [
  { title: "India - Location and Size", topics: ["Latitude and longitude", "Neighboring countries", "Coastline", "Strategic location"] },
  { title: "Physiography of India", topics: ["Himalayan mountains", "Northern plains", "Peninsular plateau", "Islands"] },
  { title: "Climate of India", topics: ["Factors affecting climate", "Monsoon", "Rainfall distribution", "Climate regions"] },
  { title: "Drainage System of India", topics: ["Himalayan rivers", "Peninsular rivers", "River valleys", "Inland drainage"] },
  { title: "Natural Vegetation of India", topics: ["Forest cover", "Wildlife sanctuaries", "National parks", "Biosphere reserves"] },
  { title: "Population of India", topics: ["Census data", "Population density", "Migration", "Growth"] },

];

export default function NineGeography() {
