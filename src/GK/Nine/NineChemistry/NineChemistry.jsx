...
const chapters = [
  { title: "Atomic Structure", topics: ["Bohr model", "Quantum numbers", "Electronic configuration", "Isotopes"] },
  { title: "Periodic Table", topics: ["Modern periodic table", "s p d f blocks", "Periodic trends", "Atomic radius"] },
  { title: "Chemical Bonding", topics: ["Types of bonds", "Coordinate bond", "VSEPR", "Hybridization"] },
  { title: "Acids Bases and Salts", topics: ["Arrhenius theory", "Bronsted-Lowry", "Lewis theory", "Buffer solutions"] },
  { title: "Chemical Calculations", topics: ["Mole concept", "Molar mass", "Stoichiometry", "Limiting reagent"] },
  { title: "States of Matter", topics: ["Kinetic theory", "Ideal gas equation", "Real gases", "Gas laws"] },

];

export default function NineChemistry() {
