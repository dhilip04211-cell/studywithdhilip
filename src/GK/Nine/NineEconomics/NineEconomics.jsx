...
const chapters = [
  { title: "Introduction to Macro Economics", topics: ["Meaning and scope", "National income concepts", "GDP and GNP", "Standard of living"] },
  { title: "National Income", topics: ["GDP calculation", "NNP", "Net National Income", "Real vs Nominal"] },
  { title: "Money and Banking", topics: ["Functions of money", "Credit creation", "RBI", "Monetary policy"] },
  { title: "Public Finance", topics: ["Revenue and expenditure", "Fiscal deficit", "Government borrowing", "Taxation"] },
  { title: "Economic Planning in India", topics: ["Planning Commission", "Five Year Plans", "NITI Aayog", "Plan achievements"] },
  { title: "Poverty and Unemployment", topics: ["Poverty line", "BPL population", "Unemployment types", "Employment schemes"] },

];

export default function NineEconomics() {
