...
const chapters = [
  { title: "French Revolution", topics: ["Causes", "Reign of Terror", "Napoleon", "Legacy"] },
  { title: "Russian Revolution", topics: ["Causes", "Bolshevik Party", "Lenin and Stalin", "Soviet Union"] },
  { title: "World War I", topics: ["Alliance systems", "Assassination of Franz Ferdinand", "Major battles", "Treaty of Versailles"] },
  { title: "World War II", topics: ["Rise of Fascism", "Nazi Germany", "Pearl Harbor", "UN formation"] },
  { title: "Indian National Movement - Early Phase", topics: ["INC formation", "Moderates", "Partition of Bengal 1905", "Swadeshi Movement"] },
  { title: "Moderate and Extremist Leaders", topics: ["Bal Gangadhar Tilak", "Lala Lajpat Rai", "Bipin Chandra Pal", "Split in INC"] },

];

export default function NineIndianHistory() {
