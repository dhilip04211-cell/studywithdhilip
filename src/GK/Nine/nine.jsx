...
export default function Nine({ onNavigate, onBack }) {
    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          <div style={{...styles.classBadge, background: "#4A90D922", border: `1px solid #4A90D955`, color: "#4A90D9"}}>
            CLASS IX
          </div>
...
const styles = {
  ...
  bgGlow: {
    position: "absolute",
    inset: 0,
    background: `radial-gradient(ellipse at 30% 20%, #4A90D918 0%, transparent 55%), radial-gradient(ellipse at 70% 80%, #4A90D90e 0%, transparent 55%)`,
    pointerEvents: "none",
  },
  container: {
    width: "100%",
