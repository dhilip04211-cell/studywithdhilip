...
const chapters = [
  { title: "Colonial Tamil Nadu", topics: ["British annexation", "Palayakkarar revolts", "Polygar wars", "Kattabomman"] },
  { title: "Tamil Nationalism", topics: ["V.O. Chidambaram Pillai", "Subramania Bharati", "Early nationalists", "Swadeshi"] },
  { title: "Self-Respect Movement", topics: ["Periyar's ideology", "Self-Respect Movement", "Widow remarriage", "Women's rights"] },
  { title: "Justice Party", topics: ["Justice Party", "Communal GO", "Non-Brahmin movement", "Political demands"] },
  { title: "Dravidian Movement", topics: ["Thanthai Periyar", "Dr. Anna", "Formation of DMK", "Two-nation rejection"] },
  { title: "Social Reformers of Tamil Nadu", topics: ["Iyothee Thass", "Ayya Vaikunda", "Ramalinga Swamigal", "Maraimalai Adigal"] },

];

export default function NineTamilnaduHistory() {
