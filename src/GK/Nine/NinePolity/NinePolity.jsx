...
const chapters = [
  { title: "Democracy and its Forms", topics: ["Direct democracy", "Representative", "Parliamentary vs Presidential", "India"] },
  { title: "Electoral Process", topics: ["Types of elections", "Delimitation", "Election process", "NOTA"] },
  { title: "Political Parties", topics: ["National parties", "Regional parties", "Party system", "Anti-defection"] },
  { title: "The Legislature", topics: ["Bicameral legislature", "Unicameral", "Parliamentary privileges", "Quorum"] },
  { title: "The Executive", topics: ["PM and cabinet", "Bureaucracy", "Role of IAS", "Checks and balances"] },
  { title: "The Judiciary", topics: ["Original jurisdiction", "Appellate", "PIL", "Independence of judiciary"] },

];

export default function NinePolity() {
