...
const chapters = [
  { title: "World Population", topics: ["World population distribution", "Demographic transition", "Population policies", "Aging"] },
  { title: "Human Settlements", topics: ["Rural settlements", "Urban settlements", "Urbanization", "Smart cities"] },
  { title: "Economic Geography", topics: ["Agriculture types", "Industrial regions", "Tertiary sector", "Trade patterns"] },
  { title: "Transport and Communication", topics: ["Road transport", "Railways", "Air transport", "Waterways"] },
  { title: "International Trade", topics: ["Exports and imports", "Trade blocs", "WTO", "India's trade"] },
  { title: "Geographical Thought", topics: ["Environmental determinism", "Possibilism", "Geopolitics", "Modern geography"] },

];

export default function TwelveGeography() {
