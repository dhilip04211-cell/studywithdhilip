...
const chapters = [
  { title: "Macro Economics - Introduction", topics: ["Circular flow", "Aggregate demand and supply", "Keynesian model", "Multiplier"] },
  { title: "National Income Accounting", topics: ["GDP measurement", "Value added method", "Income method", "Expenditure method"] },
  { title: "Money Supply and Banking", topics: ["Functions of RBI", "Credit control", "CRR SLR Repo rate", "Inflation"] },
  { title: "Government Budget", topics: ["Components of budget", "Fiscal policy", "Revenue and capital", "FRBM"] },
  { title: "Balance of Payments", topics: ["Current account", "Capital account", "Exchange rates", "Forex reserves"] },
  { title: "Indian Economic Issues", topics: ["Agricultural challenges", "Industrial policy", "Poverty and inequality", "Digital economy"] },

];

export default function TwelveEconomics() {
