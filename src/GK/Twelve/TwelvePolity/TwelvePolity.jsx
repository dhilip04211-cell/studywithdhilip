...
const info = {
  ...
  classColor: "#9B59B6",
  backRoute: "/gk/twelve",
  subjectRoute: "/gk/twelve/twelvepolity",
};

const chapters = [
  {
    title: "Indian Constitution - Making",
    topics: [
      "Objectives and Preamble",
      "Influence of world constitutions",
      "Ambedkar's role",
      "Key debates",
    ],
  },
  ...
  {
    title: "Parliament and State Legislature",
    topics: [
  ...
  {
    title: "International Relations and India",
    topics: [
      "Foreign policy",
      "Neighbour relations",
      "UNO and India",
