...
const chapters = [
  { title: "Indian Constitution - Making", topics: ["Objectives and Preamble", "Influence of world constitutions", "Ambedkar's role", "Key debates"] },
  { title: "Union Executive", topics: ["President's powers", "Vice President", "PM and CoM", "Cabinet committees"] },
  { title: "State Executive", topics: ["Governor", "Chief Minister", "State cabinet", "Relationship with Centre"] },
  { title: "Parliament and State Legislature", topics: ["Legislative procedure", "Budget process", "Question hour", "Committees"] },
  { title: "Judicial System", topics: ["Structure of courts", "Judicial activism", "Judicial restraint", "Tribunals"] },
  { title: "Federalism in India", topics: ["Quasi-federalism", "Finance Commission", "NITI Aayog", "Cooperative federalism"] },

];

export default function TwelvePolity() {
