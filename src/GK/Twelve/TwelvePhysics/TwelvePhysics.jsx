...
const chapters = [
  { title: "Electrostatics", topics: ["Coulomb's law", "Electric field", "Gauss's theorem", "Capacitors"] },
  { title: "Current Electricity", topics: ["Ohm's law", "Kirchhoff's laws", "Wheatstone bridge", "Potentiometer"] },
  { title: "Magnetism", topics: ["Magnetic field", "Biot-Savart law", "Ampere's law", "Magnetic properties"] },
  { title: "Electromagnetic Induction", topics: ["Faraday's laws", "Lenz's law", "Self and mutual inductance", "AC circuits"] },
  { title: "Optics", topics: ["Reflection and refraction", "Diffraction", "Interference", "Polarization"] },
  { title: "Atomic Physics", topics: ["Photoelectric effect", "Matter waves", "Bohr model", "X-rays"] },

];

export default function TwelvePhysics() {
