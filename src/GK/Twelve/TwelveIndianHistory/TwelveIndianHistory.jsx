...
const chapters = [
  { title: "Colonial Economy", topics: ["Drain of wealth", "De-industrialization", "Land revenue", "Famines"] },
  { title: "Social Reform Movements", topics: ["Raja Ram Mohan Roy", "Brahmo Samaj", "Arya Samaj", "Theosophical Society"] },
  { title: "Revolutionary Nationalism", topics: ["Bhagat Singh", "Chandrashekhar Azad", "Subhas Chandra Bose", "INA"] },
  { title: "Constitution Making", topics: ["Constituent Assembly", "Ambedkar's role", "Key features", "Preamble"] },
  { title: "Post-Independence India", topics: ["Five Year Plans", "Non-alignment", "Wars and crises", "Economic liberalization"] },
  { title: "Foreign Policy of India", topics: ["Nehru's foreign policy", "Panchsheel", "India-China war", "India-Pakistan wars"] },
