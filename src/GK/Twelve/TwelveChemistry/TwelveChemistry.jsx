...
const chapters = [
  { title: "Metallurgy", topics: ["Occurrence of metals", "Concentration of ores", "Extraction", "Refining"] },
  { title: "p-Block Elements", topics: ["Boron family", "Carbon family", "Nitrogen family", "Oxygen and halogens"] },
  { title: "d-Block Elements", topics: ["Transition elements", "Properties", "Complex ions", "Catalytic properties"] },
  { title: "Coordination Chemistry", topics: ["Ligands and coordination number", "Nomenclature", "Isomerism", "Applications"] },
  { title: "Organic Reactions", topics: ["Substitution reactions", "Addition reactions", "Elimination", "Named reactions"] },
  { title: "Biomolecules", topics: ["Carbohydrates", "Proteins and amino acids", "Lipids", "Nucleic acids"] },

];

export default function TwelveChemistry() {
