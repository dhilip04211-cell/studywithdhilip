...
const chapters = [
  { title: "Reproduction in Plants", topics: ["Modes of reproduction in plants", "Pollination types", "Double fertilization", "Apomixis"] },
  { title: "Genetics and Evolution", topics: ["Mendelian genetics", "Chromosomal inheritance", "Linkage and crossing over", "Gene mapping"] },
  { title: "Biology in Human Welfare", topics: ["Microbes in food production", "Biogas", "Bioremediation", "Sewage treatment"] },
  { title: "Biotechnology", topics: ["Recombinant DNA technology", "Transgenic organisms", "Gene therapy", "Bioethics"] },
  { title: "Ecology", topics: ["Organisms and environment", "Population ecology", "Community ecology", "Ecosystem services"] },
  { title: "Environmental Issues", topics: ["Air and water pollution", "Solid waste", "Ozone depletion", "Environmental laws"] },

];

export default function TwelveBiology() {
