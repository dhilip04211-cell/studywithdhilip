...
const chapters = [
  { title: "Modern Tamil Nadu Society", topics: ["Caste system changes", "Urbanization", "Migration", "Social welfare"] },
  { title: "Tamil Literary Renaissance", topics: ["Tamil literary revival", "U.V. Swaminatha Iyer", "Journals", "Printing press"] },
  { title: "Political Parties in Tamil Nadu", topics: ["DMK", "AIADMK", "Congress in Tamil Nadu", "Coalition politics"] },
  { title: "Economic Development of Tamil Nadu", topics: ["Green Revolution", "IT sector", "Industrial corridors", "SMEs"] },
  { title: "Education in Tamil Nadu", topics: ["University of Madras", "Anna University", "IIT Madras", "Literacy"] },
  { title: "Art and Culture of Tamil Nadu", topics: ["Bharatanatyam", "Carnatic music", "Tamil film", "Festivals"] },

];

export default function TwelveTamilnaduHistory() {
