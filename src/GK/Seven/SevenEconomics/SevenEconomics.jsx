...
const chapters = [
  { title: "Economic Activities", topics: ["Primary activities", "Secondary activities", "Tertiary", "Interdependence"] },
  { title: "Agriculture as Livelihood", topics: ["Types of farming", "Green Revolution", "Agricultural problems", "Rural economy"] },
  { title: "Industries", topics: ["Cottage industries", "Small scale", "Large scale", "Industrial location"] },
  { title: "Services Sector", topics: ["Trade", "Transport", "Communication", "Finance and banking"] },
  { title: "Market Types", topics: ["Perfect competition", "Monopoly", "Oligopoly", "Consumer surplus"] },
  { title: "Consumer Awareness", topics: ["Consumer rights", "Consumer Protection Act", "Consumer forums", "Redressal"] },

];

export default function SevenEconomics() {
