...
const chapters = [
  { title: "Laws of Motion", topics: ["Newton's laws", "Types of motion", "Velocity and acceleration", "Equations of motion"] },
  { title: "Gravitation", topics: ["Universal gravitation", "Weight vs mass", "Gravitational acceleration", "Free fall"] },
  { title: "Heat", topics: ["Temperature and heat", "Thermal expansion", "Conduction convection radiation", "Calorimetry"] },
  { title: "Optics", topics: ["Laws of reflection", "Mirrors", "Refraction", "Lenses"] },
  { title: "Sound Waves", topics: ["Properties of sound", "Speed of sound", "Resonance", "Applications"] },
  { title: "Electricity and Circuits", topics: ["Current voltage resistance", "Ohm's law", "Series and parallel", "Heating effect"] },

];

export default function SevenPhysics() {
