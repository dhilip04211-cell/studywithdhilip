...
const chapters = [
  { title: "Atomic Structure", topics: ["Dalton's theory", "Sub-atomic particles", "Thomson model", "Rutherford model"] },
  { title: "Chemical Bonding", topics: ["Ionic bonding", "Covalent bonding", "Metallic bonding", "Polarity"] },
  { title: "Acids Bases and Salts", topics: ["Strong and weak acids", "Strong and weak bases", "Salts", "Neutralization"] },
  { title: "Chemical Reactions", topics: ["Types of reactions", "Oxidation and reduction", "Endothermic exothermic", "Reaction rates"] },
  { title: "Carbon Compounds", topics: ["Hydrocarbons", "Alkanes alkenes alkynes", "Functional groups", "Polymers"] },
  { title: "Periodic Table Basics", topics: ["Periods and groups", "Metals and non-metals", "Periodicity", "Mendeleev"] },

];

export default function SevenChemistry() {
