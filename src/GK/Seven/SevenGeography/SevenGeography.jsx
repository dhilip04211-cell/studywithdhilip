...
const chapters = [
  { title: "Interior of the Earth", topics: ["Earth's layers", "Crust mantle core", "Tectonic plates", "Earthquakes"] },
  { title: "Rocks and Minerals", topics: ["Types of rocks", "Igneous", "Sedimentary", "Metamorphic"] },
  { title: "Atmosphere", topics: ["Atmosphere composition", "Layers", "Pressure belts", "Wind systems"] },
  { title: "Hydrosphere", topics: ["Ocean currents", "Tides", "Salinity", "Marine resources"] },
  { title: "Natural Vegetation", topics: ["Forest types", "Grasslands", "Deserts", "Polar vegetation"] },
  { title: "Wildlife and Biosphere", topics: ["Biosphere", "Ecosystem", "Food chain", "Conservation"] },

];

export default function SevenGeography() {
