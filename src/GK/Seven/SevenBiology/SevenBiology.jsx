...
const chapters = [
  { title: "Cell Structure and Function", topics: ["Cell membrane", "Nucleus", "Mitochondria", "Chloroplast and others"] },
  { title: "Plant Kingdom", topics: ["Monera and Protista", "Fungi", "Plantae", "Animalia"] },
  { title: "Animal Kingdom", topics: ["Vertebrates and invertebrates", "Classification", "Adaptation", "Economic importance"] },
  { title: "Nutrition in Plants and Animals", topics: ["Photosynthesis", "Nutrition in animals", "Digestive enzymes", "Absorption"] },
  { title: "Respiration", topics: ["Aerobic and anaerobic", "Respiration in plants", "Animals", "Exchange of gases"] },
  { title: "Transportation in Living Things", topics: ["Blood and blood groups", "Heart and circulation", "Transport in plants", "Lymphatic system"] },

];

export default function SevenBiology() {
