...
const chapters = [
  { title: "The Sangam Age", topics: ["Sangam period overview", "Three crowned kings", "Trade and commerce", "Sangam literature"] },
  { title: "The Gupta Empire", topics: ["Gupta rulers", "Administration", "Cultural achievements", "Decline"] },
  { title: "The Pallavas", topics: ["Pallava architecture", "Mahabalipuram", "Pallava rulers", "Art and culture"] },
  { title: "The Chalukyas", topics: ["Chalukya rulers", "Cave temples", "Architecture", "Decline"] },
  { title: "The Cholas", topics: ["Chola navy", "Administration", "Temple building", "Expansion"] },
  { title: "Bhakti Movement", topics: ["Bhakti saints", "Alwars and Nayanmars", "Social reform", "Bhakti literature"] },
