...
const chapters = [
  { title: "The Pallavas of Kanchi", topics: ["Simhavishnu", "Mahendravarman I", "Narasimhavarman I", "Capital Kanchi"] },
  { title: "The Pandyas", topics: ["Later Pandyas", "Jatavarman Sundara", "Maravarman Kulasekaran", "Pandya trade"] },
  { title: "The Cheras", topics: ["Chera rulers", "Kulasekara Alwar", "Kerala connection", "Western Ghats"] },
  { title: "The Later Cholas", topics: ["Rajaraja Cholan I", "Rajendra Cholan I", "Chola navy", "Gangaikonda Cholapuram"] },
  { title: "Medieval Tamil Society", topics: ["Joint family", "Women in medieval period", "Temple as social centre", "Guild economy"] },
  { title: "Temple Architecture in Tamil Nadu", topics: ["Dravidian architecture", "Gopuram", "Temple sculpture", "Bronze art"] },

];

export default function SevenTamilnaduHistory() {
