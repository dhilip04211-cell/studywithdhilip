...
const classes = [
  { label: "Class VI", file: "Six", color: "#FF6B35" },
  { label: "Class VII", file: "Seven", color: "#F7C59F" },
  { label: "Class VIII", file: "Eight", color: "#EFEFD0" },
  { label: "Class IX", file: "Nine", color: "#004E89" },
  { label: "Class X", file: "Ten", color: "#1A936F" },
  { label: "Class XI", file: "Eleven", color: "#C6384B" },
