...
const chapters = [
  { title: "Fundamentals of Physical Geography", topics: ["Internal structure", "Continental drift", "Plate tectonics", "Isostasy"] },
  { title: "Geomorphology", topics: ["Weathering", "Erosion and deposition", "Fluvial landforms", "Coastal landforms"] },
  { title: "Climatology", topics: ["Insolation", "Albedo", "Temperature distribution", "Atmospheric circulation"] },
  { title: "Oceanography", topics: ["Ocean floor", "Temperature and salinity", "Waves and currents", "El Nino"] },
  { title: "Biogeography", topics: ["Ecosystem types", "Biomes", "Biodiversity", "Conservation"] },
  { title: "Map and Remote Sensing", topics: ["Types of maps", "Map projections", "Remote sensing", "GIS"] },

];

export default function ElevenGeography() {
