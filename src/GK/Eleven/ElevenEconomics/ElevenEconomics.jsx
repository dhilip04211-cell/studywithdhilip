...
const chapters = [
  { title: "Introduction to Micro Economics", topics: ["Central problems", "Economic systems", "PPF", "Opportunity cost"] },
  { title: "Demand Analysis", topics: ["Law of Demand", "Demand curve", "Shifts in demand", "Elasticity"] },
  { title: "Supply Analysis", topics: ["Law of Supply", "Supply curve", "Elasticity of supply", "Producer equilibrium"] },
  { title: "Market Equilibrium", topics: ["Price determination", "Consumer equilibrium", "Market forms", "Walras law"] },
  { title: "Production Theory", topics: ["Total product AP MP", "Laws of returns", "Isoquant", "Returns to scale"] },
  { title: "Cost and Revenue", topics: ["Total cost ATC MC", "TR AR MR", "Profit maximization", "Break-even"] },

];

export default function ElevenEconomics() {
