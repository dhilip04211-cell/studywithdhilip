...
const chapters = [
  { title: "Nature of Physical World", topics: ["Measurement systems", "Vectors and scalars", "Resolution", "Vector products"] },
  { title: "Kinematics", topics: ["Frame of reference", "Equations of motion", "Circular motion", "Projectile"] },
  { title: "Laws of Motion", topics: ["Newton's laws", "Conservation of momentum", "Friction", "Applications"] },
  { title: "Work Energy and Power", topics: ["Work energy theorem", "KE and PE", "Power", "Collisions"] },
  { title: "Gravitation", topics: ["Kepler's laws", "Escape velocity", "Orbital velocity", "Gravitational potential"] },
  { title: "Properties of Matter", topics: ["Elasticity", "Surface tension", "Viscosity", "Fluid dynamics"] },

];

export default function ElevenPhysics() {
