...
const chapters = [
  { title: "Ancient Tamil Polity", topics: ["Ancient polity", "Assembly Manram", "Administrative divisions", "Local governance"] },
  { title: "Sangam Economy", topics: ["Agricultural economy", "Pastoral economy", "Trade ports Puhar Korkai", "Currency"] },
  { title: "Sangam Society", topics: ["Five tinais", "Social classes", "Marriage customs", "Heroic values"] },
  { title: "Post-Sangam Period", topics: ["Kalabhra interregnum", "Pallava rise", "Pandya revival", "Chera decline"] },
  { title: "Tamil Bhakti Movement", topics: ["Nayanmars 63 saints", "Alwars 12 saints", "Temple hymns", "Social impact"] },
  { title: "Chola Administration", topics: ["Revenue administration", "Army and Navy", "Village assemblies", "Inscriptions"] },

];

export default function ElevenTamilnaduHistory() {
