...
const chapters = [
  { title: "Basic Concepts of Chemistry", topics: ["Scientific method", "SI units", "Significant figures", "Concentration terms"] },
  { title: "Quantum Mechanical Model", topics: ["Wave mechanical model", "Orbitals", "Aufbau principle", "Hund's rule"] },
  { title: "Periodic Table - Advanced", topics: ["Long form periodic table", "Periodic properties", "Anomalies", "Noble gases"] },
  { title: "Chemical Bonding", topics: ["Lattice energy", "Fajan's rules", "Molecular orbital theory", "Hybridization"] },
  { title: "Thermodynamics", topics: ["Laws of thermodynamics", "Enthalpy and entropy", "Gibbs free energy", "Spontaneity"] },
  { title: "Chemical Equilibrium", topics: ["Ionization constant", "Common ion effect", "Solubility product", "Lewis acids bases"] },

];

export default function ElevenChemistry() {
