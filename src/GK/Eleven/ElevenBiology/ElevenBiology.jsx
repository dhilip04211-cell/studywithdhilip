...
const chapters = [
  { title: "Living World", topics: ["Diversity of life", "Classification history", "Taxonomic hierarchy", "Botanical gardens"] },
  { title: "Cell Biology", topics: ["Biomembranes", "Endomembrane system", "Cytoskeleton", "Cell signalling"] },
  { title: "Biomolecules", topics: ["Carbohydrates", "Lipids", "Proteins", "Nucleic acids"] },
  { title: "Plant Morphology", topics: ["Root stem leaf anatomy", "Flower structure", "Fruit and seed", "Modifications"] },
  { title: "Plant Physiology", topics: ["Photosynthesis mechanisms", "Respiration", "Plant growth regulators", "Photoperiodism"] },
  { title: "Human Physiology", topics: ["Digestion", "Breathing and gas exchange", "Body fluids", "Locomotion"] },

];

export default function ElevenBiology() {
