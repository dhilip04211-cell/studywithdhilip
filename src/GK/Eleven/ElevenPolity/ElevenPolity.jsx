...
const chapters = [
  { title: "Introduction to Political Science", topics: ["Nature of political science", "Relation with subjects", "Methods", "Scope"] },
  { title: "Origin of State", topics: ["Divine origin theory", "Force theory", "Social contract", "Evolutionary theory"] },
  { title: "Theories of State", topics: ["Monistic theory", "Pluralistic", "Idealist", "Marxist"] },
  { title: "Sovereignty", topics: ["Meaning of sovereignty", "Characteristics", "Austin's theory", "Laski's criticism"] },
  { title: "Rights and Liberty", topics: ["Natural rights", "Legal rights", "Kinds of liberty", "Rights vs duties"] },
  { title: "Political Ideologies", topics: ["Liberalism", "Socialism", "Communism", "Fascism"] },

];

export default function ElevenPolity() {
