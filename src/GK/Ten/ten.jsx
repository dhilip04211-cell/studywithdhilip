...
export default function Ten({ onNavigate, onBack }) {
...
const styles = {
  ...
  bgGlow: {
    position: "absolute",
    inset: 0,
    background: `radial-gradient(ellipse at 30% 20%, #1A936F18 0%, transparent 55%), radial-gradient(ellipse at 70% 80%, #1A936F0e 0%, transparent 55%)`,
    pointerEvents: "none",
  },
  container: {
    width: "100%",
