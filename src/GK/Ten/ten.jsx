...
const subjects = [
  ...
  { route: "/gk/ten/tentamilnaduhistory", label: "Tamilnadu History", icon: "🌺", color: "#E67E22" },
  { route: "/gk/ten/tengeography", label: "Geography", icon: "🌍", color: "#27AE60" },
  { route: "/gk/ten/tenpolity", label: "Polity", icon: "⚖️", color: "#2980B9" },
  { route: "/gk/ten/teneconomics", label: "Economics", icon: "📈", color: "#8E44AD" },
  { route: "/gk/ten/tenphysics", label: "Physics", icon: "⚛️", color: "#16A085" },
  { route: "/gk/ten/tenchemistry", label: "Chemistry", icon: "🧪", color: "#D35400" },
  { route: "/gk/ten/tenbiology", label: "Biology", icon: "🧬", color: "#C0392B" },
];
  ...
  return (
    <div style={styles.page}>
      <div style={styles.container}>
        <button style={styles.backBtn} onClick={() => navigate("/gk")}>
          ← Back to Classes
        </button>
