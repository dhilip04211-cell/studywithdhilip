...
const chapters = [
  { title: "Tamil Nadu - Physical Features", topics: ["Location and boundaries", "Districts", "Physiographic divisions", "Coastline"] },
  { title: "Tamil Nadu - Climate", topics: ["Rainfall patterns", "Temperature", "Cyclones", "Northeast monsoon"] },
  { title: "Tamil Nadu - Water Resources", topics: ["River basins", "Mettur dam", "Tanks and lakes", "Groundwater"] },
  { title: "Tamil Nadu - Agriculture", topics: ["Food crops", "Commercial crops", "Horticulture", "Challenges"] },
  { title: "Tamil Nadu - Industries", topics: ["Textile industry", "Auto industry", "IT parks", "Special Economic Zones"] },
  { title: "Tamil Nadu - Population", topics: ["Urban-rural ratio", "Tribal population", "Literacy rate", "HDI"] },

];

export default function TenGeography() {
