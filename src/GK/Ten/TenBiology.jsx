...
const chapters = [
  { title: "Plant Anatomy", topics: ["Plant tissues", "Meristematic tissue", "Permanent tissue", "Animal tissues"] },
  { title: "Plant Physiology", topics: ["Water and mineral absorption", "Transpiration", "Stomata", "Photosynthesis pathways"] },
  { title: "Human Anatomy", topics: ["Skeletal system", "Muscular system", "Circulatory system", "Digestive system"] },
  { title: "Nervous System", topics: ["Neurons", "CNS and PNS", "Sense organs", "Reflex action"] },
  { title: "Reproduction and Genetics", topics: ["Mendel's experiments", "Chromosomal theory", "Mutation", "Evolution evidence"] },
  { title: "Environmental Science", topics: ["Ecosystem components", "Food web", "Biogeochemical cycles", "Conservation"] },

];

export default function TenBiology() {
