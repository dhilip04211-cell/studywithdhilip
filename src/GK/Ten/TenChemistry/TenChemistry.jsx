...
const chapters = [
  { title: "Periodic Classification", topics: ["Periodic law", "Groups and periods", "Periodic trends", "Applications"] },
  { title: "Chemical Bonding", topics: ["Types of bonds", "Bond polarity", "Intermolecular forces", "Properties"] },
  { title: "Acids Bases and Salts", topics: ["Preparation of salts", "Types of salts", "Salt hydrolysis", "Uses"] },
  { title: "Chemical Reactions", topics: ["Types of reactions", "Rate of reaction", "Catalysis", "Electrolysis"] },
  { title: "Carbon and its Compounds", topics: ["Hydrocarbons", "Alcohols and aldehydes", "Carboxylic acids", "Polymers"] },
  { title: "Nuclear Chemistry", topics: ["Natural and artificial radioactivity", "Half-life", "Nuclear reactions", "Safety"] },

];

export default function TenChemistry() {
