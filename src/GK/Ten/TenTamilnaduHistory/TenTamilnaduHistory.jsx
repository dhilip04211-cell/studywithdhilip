...
const chapters = [
  { title: "Role of Tamil Nadu in Freedom Struggle", topics: ["Coimbatore Case", "Tirunelveli riots", "VOC steamship", "Bipin Chandra Pal in TN"] },
  { title: "V.O. Chidambaram Pillai", topics: ["VOC life", "Coral Mill strike", "Imprisonment", "Legacy"] },
  { title: "Subramania Bharati", topics: ["Bharati's songs", "Kuyil Pattu", "Feminist writings", "National integration"] },
  { title: "Periyar E.V. Ramasamy", topics: ["Periyar's ideology", "Dravidam", "Attacks on caste", "Marriage reform"] },
  { title: "Dr. Ambedkar and Tamil Nadu", topics: ["Ambedkar's visits", "Dalit movement", "Conversion", "Tamil Dalit leaders"] },
  { title: "Formation of Tamil Nadu State", topics: ["Madras State", "Linguistic reorganization", "Rajaji's role", "Tamil Nadu 1969"] },

];

export default function TenTamilnaduHistory() {
