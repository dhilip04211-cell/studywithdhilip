...
const chapters = [
  { title: "Development", topics: ["Economic development vs growth", "HDI components", "UNDP", "Sustainable development"] },
  { title: "Sectors of Indian Economy", topics: ["Primary sector", "Secondary", "Tertiary", "Changing GDP shares"] },
  { title: "Money and Credit", topics: ["Money evolution", "Banking system", "Self Help Groups", "Micro finance"] },
  { title: "Globalisation", topics: ["WTO and India", "MNCs", "FDI", "Pros and cons of globalization"] },
  { title: "Consumer Rights", topics: ["Consumer rights", "COPRA 1986", "Consumer courts", "Consumer awareness"] },
  { title: "Economic Reforms in India", topics: ["1991 reforms", "Liberalization", "Privatization", "Globalization effects"] },

];

export default function TenEconomics() {
