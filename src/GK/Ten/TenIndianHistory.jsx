...
const chapters = [
  { title: "Early Nationalist Movement", topics: ["Formation of INC", "Early demands", "Moderates", "Partition of Bengal"] },
  { title: "Non-Cooperation Movement", topics: ["Gandhi's return", "Champaran", "Rowlatt Act", "Non-cooperation launch"] },
  { title: "Civil Disobedience Movement", topics: ["Salt March", "Civil Disobedience", "Gandhi-Irwin Pact", "Round Table Conferences"] },
  { title: "Quit India Movement", topics: ["Causes and launch", "Individual Satyagraha", "August Kranti", "Suppression"] },
  { title: "Partition and Independence", topics: ["Cabinet Mission", "Mountbatten Plan", "August 15 1947", "Consequences"] },
  { title: "Integration of Princely States", topics: ["Sardar Patel's role", "Accession of states", "Hyderabad and Junagadh", "Merger"] },
