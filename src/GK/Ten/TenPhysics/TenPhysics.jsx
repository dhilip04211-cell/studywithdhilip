...
const chapters = [
  { title: "Laws of Motion and Gravitation", topics: ["Newton's laws", "Gravitational force", "Satellite motion", "Escape velocity"] },
  { title: "Optics", topics: ["Reflection and refraction", "Lenses", "Eye defects", "Optical instruments"] },
  { title: "Thermal Energy", topics: ["Specific heat", "Latent heat", "Expansion of gases", "Thermal engines"] },
  { title: "Electricity", topics: ["Static electricity", "Current electricity", "Ohm's law", "Electrical appliances"] },
  { title: "Acoustics", topics: ["Properties of sound", "Frequency and pitch", "Reflection of sound", "Sonar"] },
  { title: "Nuclear Physics", topics: ["Radioactivity", "Nuclear reactions", "Nuclear energy", "Effects of radiation"] },

];

export default function TenPhysics() {
