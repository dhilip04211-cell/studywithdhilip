...
const chapters = [
  { title: "Matter in States", topics: ["Solid liquid gas", "Interconversion", "Evaporation", "Sublimation"] },
  { title: "Atomic Structure", topics: ["Bohr model", "Electron configuration", "Valence electrons", "Ions"] },
  { title: "Periodic Classification", topics: ["Dobereiner's Triads", "Newlands Octaves", "Mendeleev", "Modern Periodic Law"] },
  { title: "Chemical Bonding", topics: ["Ionic bonds", "Covalent bonds", "Lewis structures", "Electronegativity"] },
  { title: "Acids and Bases", topics: ["Litmus test", "pH of substances", "Salt hydrolysis", "Buffer solutions"] },
  { title: "Chemistry in Everyday Life", topics: ["Soaps and detergents", "Pharmaceuticals", "Fertilizers", "Dyes"] },

];

export default function EightChemistry() {
