...
export default function Eight({ onNavigate, onBack }) {
    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          <div style={{...styles.classBadge, background: "#3DBFA822", border: `1px solid #3DBFA855`, color: "#3DBFA8"}}>
            CLASS VIII
          </div>
...
const styles = {
  ...
  bgGlow: {
    position: "absolute",
    inset: 0,
    background: `radial-gradient(ellipse at 30% 20%, #3DBFA818 0%, transparent 55%), radial-gradient(ellipse at 70% 80%, #3DBFA80e 0%, transparent 55%)`,
    pointerEvents: "none",
  },
  container: {
    width: "100%",
