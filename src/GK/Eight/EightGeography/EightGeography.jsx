...
const chapters = [
  { title: "Resources", topics: ["Types of resources", "Natural vs human", "Conservation", "Sustainable development"] },
  { title: "Land and Soil Resources", topics: ["Types of soil", "Soil erosion", "Land use", "Desertification"] },
  { title: "Water Resources", topics: ["Surface water", "Groundwater", "Irrigation", "Water conservation"] },
  { title: "Mineral and Energy Resources", topics: ["Types of minerals", "Energy resources", "Fossil fuels", "Renewable energy"] },
  { title: "Agriculture", topics: ["Types of farming", "Green Revolution", "Cash crops", "Food security"] },
  { title: "Industries", topics: ["Types of industries", "Location factors", "Industrial regions", "Cottage industries"] },

];

export default function EightGeography() {
