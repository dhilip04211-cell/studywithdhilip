...
const chapters = [
  { title: "The Mughal Empire", topics: ["Babur and Humayun", "Akbar's reign", "Aurangzeb", "Mughal culture"] },
  { title: "The Maratha Empire", topics: ["Shivaji Maharaj", "Administration", "Peshwa period", "Maratha decline"] },
  { title: "European Arrival in India", topics: ["Portuguese arrival", "Dutch and French", "East India Company", "Battle of Plassey"] },
  { title: "The British East India Company", topics: ["British expansion", "Revenue systems", "Doctrine of Lapse", "Administration"] },
  { title: "Revolts Against British Rule", topics: ["Tribal uprisings", "Peasant revolts", "Sepoy mutinies", "Vellore Mutiny"] },
  { title: "The 1857 Uprising", topics: ["Causes of revolt", "Key leaders", "Suppression", "Consequences"] },
