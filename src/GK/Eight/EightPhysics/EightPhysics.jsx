...
const chapters = [
  { title: "Mechanics", topics: ["Newton's laws", "Friction", "Pressure", "Archimedes principle"] },
  { title: "Pressure", topics: ["Atmospheric pressure", "Pascal's law", "Hydraulic machines", "Buoyancy"] },
  { title: "Sound", topics: ["Wave motion", "Frequency and wavelength", "Reflection of sound", "Ultrasound"] },
  { title: "Light - Reflection and Refraction", topics: ["Laws of reflection", "Refraction", "Snell's law", "Dispersion"] },
  { title: "Electricity", topics: ["Electric circuits", "Magnetic effect", "Electromagnets", "Motors and generators"] },
  { title: "Universe and Space Science", topics: ["Stars and galaxies", "Solar system", "Space exploration", "Black holes"] },

];

export default function EightPhysics() {
