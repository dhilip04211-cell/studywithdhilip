...
const chapters = [
  { title: "The Vijayanagara Empire", topics: ["Vijayanagara rulers", "Krishnadevaraya", "Ashtadiggajas", "Hampi"] },
  { title: "The Nayaks of Tamil Nadu", topics: ["Madurai Nayaks", "Thanjavur Nayaks", "Gingee Nayaks", "Architecture"] },
  { title: "Marathas in Tamil Nadu", topics: ["Shahji and Venkoji", "Maratha music", "Thyagaraja", "Cultural fusion"] },
  { title: "European Settlements in Tamil Nadu", topics: ["Portuguese", "Dutch at Nagapattinam", "French at Pondicherry", "British at Madras"] },
  { title: "Social Conditions under British", topics: ["Zamindari system", "Forced labour", "Missionary influence", "Education"] },
  { title: "Tamil Literature in Medieval Period", topics: ["Silappatikaram", "Manimekalai", "Medieval poetry", "Thevaram"] },

];

export default function EightTamilnaduHistory() {
