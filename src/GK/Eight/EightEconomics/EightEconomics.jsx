...
const chapters = [
  { title: "Resources and Development", topics: ["Natural resources", "Human resources", "Capital", "Resource depletion"] },
  { title: "Land and Agriculture", topics: ["Land reforms", "Agricultural productivity", "Irrigation", "Food security"] },
  { title: "Industrial Development", topics: ["Industrial policy", "Public sector", "Private sector", "Mixed economy"] },
  { title: "Service Economy", topics: ["Service sector growth", "IT industry", "Tourism", "Healthcare economy"] },
  { title: "Banking", topics: ["Central Bank RBI", "Commercial banks", "Banking reforms", "Digital banking"] },
  { title: "Indian Economy Overview", topics: ["National income", "Per capita income", "Poverty line", "HDI"] },

];

export default function EightEconomics() {
