...
const info = {
  ...
  classRoman: "VII",
  classColor: "#E8A838",
  backRoute: "/tamilbook/seven/seven",
  subjectRoute: "/tamilbook/seven/ilakkanam",
};

const chapters = [
  {
    title: "குற்றியலுகரம், குற்றியலிகரம்",
    topics: ["உயிர்", "மெய்", "குற்றியல்", "பயிற்சி"],
  },
  {
    title: "ஐகாரக் குறுக்கங்கள்",
    topics: ["ஐ", "ஒலி", "குறுக்கு", "எடுத்துக்காட்டு"],
  },
  {
    title: "வினை",
    topics: ["வினைச்சொல்", "காலங்கள்", "உருபு", "பயன்பாடு"],
  },
  {
    title: "இலக்கியவடகச் சொற்கள்",
    topics: ["இலக்கிய சொற்கள்", "பொருள்", "உரை", "எடுத்துக்காட்டு"],
  },
  {
    title: "ஓரெழுத்து ஒருமொழி, பகுபதம், பகாப்பதம்",
    topics: ["ஓரெழுத்து", "ஒருமொழி", "பகுபதம்", "பகாப்பதம்"],
  },
  {
    title: "தொழிற்பெயர்",
    topics: ["வினை", "பெயர்ச்சி", "மாற்றம்", "பயிற்சி"],
  },
  {
    title: "அணி இலக்கணம்",
    topics: ["அணி", "இயல்", "அழகு", "பயன்பாடு"],
  },
  {
    title: "அணி இலக்கணம் - 2",
    topics: ["உவமை", "உருவகம்", "அழகியல்", "உதாரணம்"],
  },
  {
    title: "ஆகுபெயர்",
    topics: ["பெயர்ச்சொல்", "ஆகுபெயர்", "வகைகள்", "எடுத்துக்காட்டு"],
  },
];

export default function Ilakkanam() {
